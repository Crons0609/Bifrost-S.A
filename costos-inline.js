    ...
    function guardarRecetaLujo() {
      ...
      const ventaTotalLote = $('r-venta-total-lote')?.textContent || '—';
      const gananciaTotalLote = $('r-ganancia-total-lote')?.textContent || '—';
      ...
      const receta = {
        ...
        res_bots: bots,
        res_cpt: cpt,
        res_venta_total_lote: ventaTotalLote,
        res_ganancia_total_lote: gananciaTotalLote,
      };
